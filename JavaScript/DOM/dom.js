...
children[0].textContent = "Обьектная модель документа";
...
statistics.innerHTML = `Количество абзацов:${paragraphs.length};Количество заголовков:${document.getElementsByTagName("h2").length};Количество картинок:${document.getElementsByTagName("img").length}`;
